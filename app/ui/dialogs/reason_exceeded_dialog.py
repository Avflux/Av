...
class ReasonExceededDialog(ctk.CTkToplevel):
    def __init__(self, parent=None, activity_info=None):
        ...
        try:
            if parent:
                # Tentar obter posição e dimensões da janela pai
                ...
                # Se não houver parent, centralizar na tela
                x = (self.winfo_screenwidth() - width) // 2
                y = (self.winfo_screenheight() - height) // 2
        ...
        # Ajustar para garantir que fique dentro da tela
        ...
        # Bind para permitir mover a janela
