...
class PerfilFrame(ctk.CTkFrame):
    ...
    def setup_ui(self):
        ...
        try:
            ...
            error_frame = ctk.CTkFrame(main_container, fg_color="#CFCFCF", corner_radius=15)
    ...
    def _create_card(self, parent, title):
        ...
        # Linha separadora
        separator = ctk.CTkFrame(card, height=2)
    ...
    def show_change_password_dialog(self):
        ...
        # Encontrar a janela pai (UserWindow ou MainWindow)
        parent_window = self.winfo_toplevel()
        ChangePasswordDialog(parent_window, self.user_data)